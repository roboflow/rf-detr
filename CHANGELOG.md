...
- Relax Albumentations version requirement to support 2.x (`albumentations>=1.4.24`). `RandomSizedCrop` configs using `height`/`width` are automatically adapted to the `size=(height, width)` API ([#786](https://github.com/roboflow/rf-detr/pull/786)).
