...
| `eval_backend`               | `Literal["hotcoco","faster_coco_eval","ufcoco"]` | `"hotcoco"` | COCO evaluation backend for detection and segmentation mAP. All three ship with `rfdetr[train]` and return identical metrics; `"faster_coco_eval"` selects the previous, slower evaluator and `"ufcoco"` selects [ultrafast-pycocotools](https://github.com/developer0hye/ultrafast-pycocotools). |
...
| `eval_backend`               | `Literal["hotcoco","faster_coco_eval","ufcoco"]` | "hotcoco"      | COCO evaluation backend; `"faster_coco_eval"` selects the previous, slower evaluator and `"ufcoco"` ultrafast-pycocotools.                                                                                                |
