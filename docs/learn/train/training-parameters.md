...
- `eval_backend="vernier"` selects [vernier](https://github.com/NoeFontana/vernier), a Rust COCO evaluator. It ships with `rfdetr[train]` like the other backends.
...
| `eval_backend`               | `Literal["hotcoco","faster_coco_eval","ufcoco","vernier"]` | "hotcoco"      | COCO evaluation backend; `"faster_coco_eval"` selects the previous, slower evaluator, `"ufcoco"` for ultrafast-pycocotools and `"vernier"` for vernier.                                                                   |
