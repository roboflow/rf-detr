...
class COCOeval:
    def __init__(
        self,
        cocoGt: typing.Optional[faster_coco_eval.core.coco.COCO] = None,
        cocoDt: typing.Optional[faster_coco_eval.core.coco.COCO] = None,
        iouType: typing.Literal["segm", "bbox", "keypoints", "keypoints_crowd", "boundary"] = "segm",
        ranges: typing.Optional[dict] = {"small": [0, 1024], "medium": [1024, 9216], "large": [9216, 10000000000.0]},
        print_function: typing.Callable = logging.Logger.info,
        extra_calc: bool = False,
        kpt_oks_sigmas: typing.Optional[typing.List[float]] = None,
        use_area: typing.Optional[bool] = True,
...
class Params:
    ...
    def __init__(
        self,
        iouType: typing.Literal["segm", "bbox", "keypoints", "keypoints_crowd", "boundary"] = "segm",
        kpt_sigmas: typing.Optional[typing.List[float]] = None,
        ranges: typing.Optional[dict] = {"small": [0, 1024], "medium": [1024, 9216], "large": [9216, 10000000000.0]},
    ):
        """
...
)  # value = typing.Literal['segm', 'bbox', 'keypoints', 'keypoints_crowd', 'boundary']
