...
__all__: list[str] = ['COCO', 'copy', 'defaultdict', 'json', 'logger', 'logging', 'maskUtils', 'np', 'os', 'pathlib', 'time', 'warnings']
class COCO:
    @staticmethod
    def load_json(json_file: typing.Union[str, os.PathLike, pathlib.PosixPath, pathlib.WindowsPath, dict, list], use_deepcopy: typing.Optional[bool] = False) -> dict:
        """
        Load a json file.
        ...
        """
    def __init__(self, annotation_file: typing.Union[str, dict, os.PathLike, pathlib.PosixPath, pathlib.WindowsPath, NoneType] = None, use_deepcopy: bool = False, print_function: typing.Callable = logging.Logger.debug):
        """
    ...
    def dump(self, output_file: typing.Union[str, os.PathLike]):
        ...
        """
    def getAnnIds(self, imgIds: typing.List[int] = list(), catIds: typing.List[int] = list(), areaRng: typing.List[float] = list(), iscrowd: bool = None) -> typing.List[int]:
        """
        ...
        """
    def getCatIds(self, catNms: typing.List[str] = list(), supNms: typing.List[str] = list(), catIds: typing.List[int] = list()) -> typing.List[int]:
        """
    ...
    def getImgIds(self, imgIds: typing.List[int] = list(), catIds: typing.List[int] = list()) -> typing.List[int]:
        ...
        """
    def get_ann_ids(self, img_ids: typing.List[int] = list(), cat_ids: typing.List[int] = list(), area_rng: typing.List[float] = list(), iscrowd: bool = None) -> typing.List[int]:
        """
        Get ann ids that satisfy given filter conditions.
        ...
        """
    def get_cat_ids(self, cat_names: typing.List[str] = list(), sup_names: typing.List[str] = list(), cat_ids: typing.List[int] = list()) -> typing.List[int]:
        """
    ...
    def loadNumpyAnnotations(self, data: numpy.ndarray) -> typing.List[dict]:
        ...
        """
    def loadRes(self, resFile: typing.Union[str, os.PathLike, pathlib.PosixPath, pathlib.WindowsPath, dict, list, numpy.ndarray], min_score: float = 0.0) -> COCO:
        """
