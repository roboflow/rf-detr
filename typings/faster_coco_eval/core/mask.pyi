...
import cv2 as cv2
from faster_coco_eval import mask_api_new_cpp as _mask
import numpy
import numpy as np
import typing
__all__: list[str] = ['ValidRleType', 'area', 'calculateRleForAllAnnotations', 'cv2', 'decode', 'encode', 'frPyObjects', 'iou', 'merge', 'np', 'opencv_available', 'rleToBoundary', 'rleToBoundaryCV', 'segmToRle', 'toBbox']
def _check_opencv():
    """
...
def area(rleObjs: typing.Union[dict, typing.List[dict]]) -> numpy.ndarray:
    ...
    """
def calculateRleForAllAnnotations(anns: typing.List[dict], img_sizes: typing.Dict[int, tuple], compute_rle: bool, compute_boundary: bool, boundary_dilation_ratio: float, boundary_cpu_count: int):
    """
...
def encode(bimask: numpy.ndarray) -> dict:
    ...
    """
def frPyObjects(objs: typing.Union[typing.List[numpy.ndarray], typing.List[typing.List[float]], numpy.ndarray, typing.List[dict], typing.List[float], dict], h: int, w: int) -> typing.Union[dict, typing.List[dict]]:
    """
    ...
    """
def iou(dt: typing.Union[typing.List[numpy.ndarray], typing.List[typing.List[float]], numpy.ndarray, typing.List[dict]], gt: typing.Union[typing.List[numpy.ndarray], typing.List[typing.List[float]], numpy.ndarray, typing.List[dict]], iscrowd: typing.List[int]) -> typing.Union[list, numpy.ndarray]:
    """
...
def toBbox(rleObjs: typing.Union[dict, typing.List[dict]]) -> numpy.ndarray:
    ...
    """
ValidRleType: typing._UnionGenericAlias  # value = typing.Union[typing.List[numpy.ndarray], typing.List[typing.List[float]], numpy.ndarray, typing.List[dict]]
