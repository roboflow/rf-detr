...
import typing
__all__: list[str] = ['COCOevalAccumulate', 'COCOevalEvaluateAccumulate', 'COCOevalEvaluateImages', 'Dataset', 'ImageEvaluation', 'InstanceAnnotation', 'calc_auc', 'get_compiler_version']
class Dataset:
    ...
    def get_cpp_annotations(self, arg0: float, arg1: float) -> list[InstanceAnnotation]:
        ...
    def get_cpp_instances(self, arg0: list[float], arg1: list[float], arg2: bool) -> list[list[list[InstanceAnnotation]]]:
        ...
...
def COCOevalAccumulate(arg0: typing.Any, arg1: list[...]) -> dict:
    ...
    """
def COCOevalEvaluateAccumulate(arg0: typing.Any, arg1: list[list[list[list[float]]]], arg2: ..., arg3: ..., arg4: list[float], arg5: list[float], arg6: bool) -> dict:
    """
    Performs evaluation and accumulation in one step.
    """
def COCOevalEvaluateImages(arg0: list[typing.Annotated[list[float], pybind11_stubgen.typing_ext.FixedSize(2)]], arg1: int, arg2: list[float], arg3: list[list[list[list[float]]]], arg4: ..., arg5: ..., arg6: list[float], arg7: list[float], arg8: bool) -> list[...]:
    """
