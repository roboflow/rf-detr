...
class TestLoadPretrainWeightsPTLCkptFormat:
    ...
    def test_ptl_ckpt_non_model_keys_in_state_dict_are_excluded(self, monkeypatch):
        ...
        keys in state_dict (optimizer, lr_scheduler) must not appear in checkpoint['model'].         Real PTL
        checkpoints contain keys like 'optimizer.param_groups' and 'lr_scheduler.last_epoch' alongside the
